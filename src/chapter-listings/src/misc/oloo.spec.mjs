...
describe('OLOO domain modeling', () => {
  ...
  it('Should create a simple Transaction model', () => {
    ...
    MoneyTransaction.init = function(transactionName, fromEmail, toEmail, funds = 0.0) {
    ...
    const inst1 = Object.create(MoneyTransaction).init('Transfer', 'luke@joj.com', 'luis@joj.com')
    inst1.addFunds(10)
    assert.equal(inst1.totalAfterFee(), 6)

    const tx1 = Object.create(MoneyTransaction).init('Transfer', 'luis@joj.com', 'luke@joj.com')
    tx1.addFunds(10)
