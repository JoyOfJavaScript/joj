...
describe('Transfer Funds Test suite', () => {
  it('Should transfer funds from one wallet to the next', async () => {
    ...
    bitcoinService.transferFunds(miner, luke, Money('₿', 20), 'Transfer ₿20 to Luke')
    await bitcoinService.minePendingTransactions(miner.address)
    ...
    bitcoinService.transferFunds(luke, ana, Money('₿', 10), 'Transfer ₿20 from Luke to Ana')
    await bitcoinService.minePendingTransactions(miner.address)
    ...
    bitcoinService.transferFunds(luke, ana, (5).btc(), 'Transfer ₿5 from Luke to Ana')
    await bitcoinService.minePendingTransactions(miner.address)
    ...
    bitcoinService.transferFunds(ana, luke, Money('₿', 5), 'Transfer ₿5 from Ana back to Luke')
    bitcoinService.transferFunds(luke, ana, Money('₿', 3), 'Transfer ₿3 from Luke back to Ana')
    await bitcoinService.minePendingTransactions(miner.address)
    ...
    assert.throws(
      () => bitcoinService.transferFunds(luke, ana, (30).btc(), 'Transfer ₿30 from Luke to Ana'),
      RangeError
    )
