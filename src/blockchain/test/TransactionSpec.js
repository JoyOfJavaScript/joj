...
describe('Transaction', () => {
  it('Should create a valid transaction', () => {
    const tx = Transaction('sally', 'luke', Funds(Money('₿', 0.1)))
...
describe('Signature', () => {
  it('Should Sign Data using a private key', () => {
    ...
    const transaction = Transaction(coinbase, luke, Funds(Money('USD', 30)))
  ...
  it('Should sign transaction with null recipient', () => {
    ...
    const transaction = Transaction(null, publicKey, Funds(Money('USD', 30)))
